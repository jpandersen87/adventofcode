...
function calcFishDays(currentState, isHistory:true, numDays?: number) : number[][];
function calcFishDays(currentState, isHistory?:false, numDays?: number) : {[key: number]: number};
